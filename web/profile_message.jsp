   ...
   <%@page import="java.sql.*" %>
    ...
    <%
                ...
                if(request.getParameter("message_id")!=null)
                    u= (String)request.getParameter("message_id");
                else
                    u=(String)session.getAttribute("message_id");
                try {  
     ...
     %>
                            <div class="container">         
                                ...
                                <div class="row">
                                    <div class="col-lg-12">   
                                        <form class="register" action="Update_Rating_Servlet" method="post">
                                            <label>Seller Rating (-10 to 10)</label>
                                            <input type="text" class="breadcrumb" name="rating" required>                               
                                            <input type="submit" class="breadcrumb"  value="Submit"/>
                                            <input type="hidden" name="person" value=<%=rs.getString("sender")%>></input> 
                                            <input type="hidden" name="type" value=<%=rs.getInt("type")%>></input>
                                            <input type="hidden" name="msg" value=<%=rs.getInt("message_id")%>></input>
                                        </form>
                                    </div>
                                </div>
                                <%
                                ...
                                %>       
                                 <div class="row">
                                    <div class="col-lg-12">   
                                        <form class="register" action="Update_Rating_Servlet" method="post">
                                            <label>Buyer Rating (-10 to 10)</label>
                                            <input type="text" class="breadcrumb" name="rating" required>                               
                                            <input type="submit" class="breadcrumb"  value="Submit"/> 
                                            <input type="hidden" name="person" value=<%=rs.getString("sender")%>></input> 
                                            <input type="hidden" name="type" value=<%=rs.getInt("type")%>></input>
                                ...
                                <div class="wrapper">
                                    ...
                                    <div class="content">
                                        <div id="form_wrapper" class="form_wrapper">
                                                ...
                                                <div class="bottom">
                                                    <form class="login active" action="create_message.jsp" method="post" >                                                      
                                                        <input type="submit" value="Answer"/> 
                                                        <input type="hidden" name="snd" value=<%=rs.getString("sender")%>></input> 
                                                        <input type="hidden" name="rcv" value=<%=rs.getString("receiver")%>></input> 
                                                        <div class="clear"></div>
                                                    </form>                         
                                                </div>
     ...
     <%
                    ...
                    pst = conn.prepareStatement("UPDATE TED.MESSAGES set IS_READ=1 where MESSAGE_ID=?");
                    pst.setString(1, u);
