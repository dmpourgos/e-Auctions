...
<head>
    ...
    <title>Profile Auction Start</title>
    ...
    <%
     ...
     %>
                            <div class="container">         
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active">Profile Auction Start</li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">   
                                        <form class="register" action="DateTimeServlet" method="post">
                                            <label>Start Time</label>
                                            <input type="datetime-local" class="breadcrumb" name="start" required>
                                            <label>End Time</label>
                                            <input type="datetime-local" class="breadcrumb" name="ends" required><br>
